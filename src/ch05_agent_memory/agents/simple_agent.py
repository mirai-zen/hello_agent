...
class SimpleAgent(Agent):
    ...
    def _run_with_tools(self,messages: str,input_text:str, max_tool_iterations:int, **kwargs) -> str:
        current_iteration = 0
        final_response = ""
        ...
        if current_iteration >= max_tool_iterations and not final_response:
            inal_response = self.llm.invoke(messages, **kwargs)
    ...
    def _execute_tool_call(self,tool_name: str,params: str) -> str:
        ...
        try: 
          ...
          if tool_name == 'calculator':
            ...
            # 其他工具使用智能参数解析
            param_dict = self._parse_tool_parameters(tool_name,params)
    ...
    def _parse_tool_parameters(self, tool_name, parameters) -> dict:
        param_dict = {}
